...
const FOIScreen = ({ navigation }) => {
    ...
    const navigateToViewRequests = (filter = 'all') => {
        ...
        // Navigate to ViewFOI if authenticated
        navigation.navigate('ViewFOI', { filter, fromNavBar: false });
    };
    ...
    // Fetch FOI requests counts from API
    const fetchRequestsCounts = async (showLoading = true) => {
        try {
            ...
            if (AppConfig.development.enableDebugLogs) {
                console.log('Fetching FOI requests counts from API');
            }
            ...
            if (response.success) {
                ...
                const counts = foiService.getRequestsCounts(requests);
                ...
                console.error('Failed to fetch FOI requests');
                setRequestsCounts({
                    pending: 0,
                    approved: 0,
                    rejected: 0,
            ...
            console.error('Error fetching FOI requests counts:', error);
            setRequestsCounts({
                pending: 0,
                approved: 0,
                rejected: 0,
                        ...
                        <View style={dynamicStyles.section}>
                            ...
                            <View style={dynamicStyles.actionsContainer}>
                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={dynamicStyles.actionContent}>
                                        <Text style={dynamicStyles.actionTitle}>
                                            {t('foi.actions.newRequest.title')}
                                        </Text>
                                        <Text style={dynamicStyles.actionDescription}>
                                            {t('foi.actions.newRequest.description')}
                                        </Text>
                                    </View>
                                    <ChevronRight24Regular
                                        style={[
                                ...
                                <TouchableOpacity
                                    ...
                                    <View style={dynamicStyles.actionContent}>
                                        <Text style={dynamicStyles.actionTitle}>
                                            {t('foi.actions.viewRequests.title')}
                                        </Text>
                                        <Text style={dynamicStyles.actionDescription}>
                                            {t('foi.actions.viewRequests.description')}
                                        </Text>
                                    </View>
                                    <ChevronRight24Regular
                                        style={[
